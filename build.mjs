...
const JS_ORDER = ['hsk.js', 'freq.js', 'sentences.js', 'pinyin.js', 'store.js', 'audio.js', 'speech.js', 'quiz.js', 'stats.js', 'cats.js', 'treasures.js', 'campaign.js', 'dragon.js', 'hsk1exam.js', 'hsk2exam.js', 'hsk3exam.js', 'hskreal.js', 'vault.js', 'push.js', 'app.js', 'views-decks.js', 'views-quiz.js', 'views-learn.js', 'views-hskexam.js', 'views-profile.js', 'views-stats.js'];
